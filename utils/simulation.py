    ...
    def startVisuals(self):
        ...
        if self.graphicParams["visuals"]:
            ...
            self.jointControlButton = p.addUserDebugParameter(
             ...
             # New buttons for controlling the gripper
            self.randomPoseButton = p.addUserDebugParameter("Random Pose", 1, 0, 1)
            self.moveUpButton = p.addUserDebugParameter("Move Up", 1, 0, 1)
